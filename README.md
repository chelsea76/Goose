...
* this fork remove sqlite3 dependency
* the intention is to make it compilable with CGO_ENABLED=0, ie:
  ```
    CGO_ENABLED=0 go get -u bitbucket.org/mudiarto/goose/cmd/goose
  ```
...
[![Build Status](https://drone.io/bitbucket.org/mudiarto/goose/status.png)](https://drone.io/bitbucket.org/mudiarto/goose/latest)

# Install

    $ go get bitbucket.org/mudiarto/goose/cmd/goose

This will install the `goose` binary to your `$GOPATH/bin` directory.

You can also build goose into your own applications by importing `bitbucket.org/mudiarto/goose/lib/goose`. Documentation is available at [godoc.org](http://godoc.org/bitbucket.org/mudiarto/goose/lib/goose).
...
import _ "bitbucket.org/mudiarto/goose/cmd/goose"
```
